  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">
          <a href="<?= base_url('permintaanbarang') ?>" class="btn btn-block bg-gradient-primary">
            Kembali </a>
        </h3>
                ...
                <tr>
                  ...
                  <?php if ($this->session->userdata('role') == '1' || $this->session->userdata('role') == '3') : ?>
                    <td>
                      ...
                      <?php if ($row['status_kasubag'] == '0') : ?>
                        <a class="btn btn-primary btn-sm tombol-persetujuan" href="<?= base_url('permintaanbarang/setujui/' . $row['id']) ?>">
                          <i class="fa fa-check"></i> Setujui Kasubag
                        </a>
                        <a class="btn btn-danger btn-sm tombol-persetujuan" href="<?= base_url('permintaanbarang/tolak/' . $row['id']) ?>">
                          <i class="fa fa-times"></i> Tolak
                        </a>
                        <a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target="#modal-ubah<?= $row['id']; ?>">
                          <i class="fa fa-edit"></i> Edit
                        </a>
                      <?php else : ?>
                        <?php if ($row['status_kasubag'] == '1') : ?>
                  ...
                  <?php if ($this->session->userdata('role') == '1' || $this->session->userdata('role') == '2') : ?>
                    <td>
                      ...
                      <?php if ($row['status_kabag'] == '0') : ?>
                        <a class="btn btn-primary btn-sm tombol-persetujuan" href="<?= base_url('permintaanbarang/setujuikabag/' . $row['id']) ?>">
                          <i class="fa fa-check"></i> Setujui Kabag
                        </a>
                        <a class="btn btn-danger btn-sm tombol-persetujuan" href="<?= base_url('permintaanbarang/tolakkabag/' . $row['id']) ?>">
                          <i class="fa fa-times"></i> Tolak
                        </a>
                        <a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target="#modal-ubah<?= $row['id']; ?>">
                          <i class="fa fa-edit"></i> Edit
