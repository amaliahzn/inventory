            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('barang') ?>">Barang Masuk</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php foreach ($barangmasuk as $row) : ?>
                    <form class="form-horizontal" action="<?= base_url('barangmasuk/ubah') ?>" autocomplete="off" method="post">
                        <input type="hidden" name="id_barangmasuk" value="<?= $row['id_barangmasuk']; ?>">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="no_invoice" value="<?= $row['no_invoice'] ?>" placeholder="Masukan No Invoice / Nota .." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="keterangan" class="col-sm-2 col-form-label">Keterangan</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="keterangan" value="<?= $row['keterangan'] ?>" placeholder="Masukan keterangan atau Boleh dikosongkan">
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
