      ...
      <div class="card-body">
        <form class="form-horizontal" action="<?= base_url('barang/simpan') ?>" autocomplete="off" method="post">
          <div class="card-body">
              ...
              <div class="col-sm-6">
                <select name="nama_kategori" class="select2 form-control" required>
                  ...
                  <?php foreach ($jb as $row) : ?>
                    <option value="<?= $row['nama_kategori']; ?>"><?= $row['kode_kategori']; ?> - <?= $row['nama_kategori']; ?></option>
                  <?php endforeach ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row">
              <label for="nama_satuan" class="col-sm-2 col-form-label">Satuan Barang</label>
              <div class="col-sm-6">
            ...
            <!-- <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" id="dengan-rupiah" class="form-control" name="harga" placeholder="Ketik harga" required>
              </div>
            </div> -->
            <!--<div class="form-group row">
              <label for="stok_minimal" class="col-sm-2 col-form-label">Stok Minimal</label>
              <div class="col-sm-6">
                <input type="number" class="form-control" name="stok_minimal" placeholder="Isikan Stok Minimal" required>
              </div>
            </div>-->
            <div class="form-group row">
