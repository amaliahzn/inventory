<div class="content-wrapper" id="barangkeluar">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('barangkeluar') ?>">Transaksi Keluar</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Data Header Barang Keluar</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php
                            foreach ($barangkeluar as $row) : ?>
                                ...
                                <div class="form-group row">
                                    <br>
                                    <label for="nama_barang" class="col-sm-4 ">No Delivery Order </label>
                                    <label for="nama_barang" class="col-sm-4">: <?= $row['no_invoice'] ?></label>
                                </div>
                                <div class="form-group row">
                                    <label for="nama_barang" class="col-sm-4 ">Tanggal : </label>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($barangkeluardetail as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            ...
                                            <td><?= $row['jumlah'] ?></td>
                                            <td>
                                                <!-- <a href="<?= base_url('barangkeluar/hapusdetail/' . $row['id'])  ?>" class="btn btn-danger btn-xs tombol-hapus">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?= base_url('barangkeluar/simpandetail') ?>" autocomplete="off" method="post">
                    <div class="form-group row">
    ...
    function hapus(id) {
        if (confirm('Yakin mau menghapus data ini?')) {
            $(document).ready(function() {
                $.ajax({
                    url: '<?php echo site_url(); ?>/barangkeluar/hapusdetail/' + id,
                    success: function() {
