    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="<?= base_url('laporan/printbarangkeluar/') . $tgl_awal . '/' . $tgl_akhir ?>" target="_blank" class="btn btn-danger mt-4">
                    <i class="fa fa-print" aria-hidden="true"></i> Print
                </a>
                <a href="<?= base_url('laporan/exportbarangkeluar/') . $tgl_awal . '/' . $tgl_akhir ?>" class="btn btn-success mt-4">
